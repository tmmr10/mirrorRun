  ...
  Widget _buildBiomeRoadmap() {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        // Current world flanked by chevrons — a light, single-line cue that
        // this row is tappable to pick / change the starting world.
        Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(Icons.chevron_left,
                size: 13, color: biomes[reached].lineL.withValues(alpha: 0.45)),
            const SizedBox(width: 8),
            Text(
